...
def save_model(args, epoch, model, model_without_ddp, optimizer, loss_scaler, is_best=False, save_freq=50):
    ...
    if loss_scaler is not None:
        ...
        if is_best:
            model.save_checkpoint(save_dir=args.output_dir, tag="best_checkpoint", client_state=client_state)
